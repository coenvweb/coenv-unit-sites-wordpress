...
<div class="row social-row">
    <div class="large-12 columns social-bar">
        ...
        <?php if (get_option('facebook')) { ?><a href="<?php echo get_option('facebook'); ?>" title="Become a fan of <?php bloginfo('name'); ?> on Facebook" target="_blank" rel="nofollow"><li><?php include("../assets/img/F_icon.svg"); ?><span class="visuallyhidden">Facebook</span></li></a><?php } ?>
