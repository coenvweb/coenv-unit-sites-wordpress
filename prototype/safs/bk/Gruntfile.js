// Generated on 2014-02-28 using generator-jade 0.5.4
'use strict';
...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      compass: {
        files: ['<%= folders.app %>/styles/{,*/}*.{scss,sass}', '<%= folders.app %>/bower_components/foundation/scss/{,*/}*.{scss,sass}'],
      ...
      server: {
        ...
        files: [
          ...
          '{.tmp,<%= folders.app %>}/bower_components/{,*/}*.js',
    ...
    copy: {
      ...
      js: {
        files: [{
          ...
          dest: '<%= folders.tmp %>',
          src: [
            'scripts/{,*/}*js', 'bower_components/**/*js', 'bower_components/**/**/*js'
          ]
        }]
      },
      css: {
