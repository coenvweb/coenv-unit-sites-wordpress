...
function add_cpt_rewrites($wp_rewrite) {
    $a_rules = generate_cpt_rewrite_rules('post', 'news-events', array('coenv-year', 'coenv-month'));
    $b_rules = generate_cpt_rewrite_rules('faculty', 'faculty-research');
    $c_rules = generate_cpt_rewrite_rules('student_blog', 'news-events/student-services-blog', array('coenv-year', 'coenv-month'));
