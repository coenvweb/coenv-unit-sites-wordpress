...
function add_cpt_rewrites($wp_rewrite) {
    $a_rules = generate_cpt_rewrite_rules('post', 'news-stories', array('coenv-year', 'coenv-month'));
    $b_rules = generate_cpt_rewrite_rules('faculty', 'faculty-research/faculty-instructor-bios');
