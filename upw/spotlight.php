<?php
/**
 * Spotlight ultimate posts widget template
 *
 * @version     2.0.0
 */
?>
...
<div class="upw-posts hfeed">
  ...
  <?php if ($upw_query->have_posts()) : ?>
      ...
      <?php while ($upw_query->have_posts()) : $upw_query->the_post(); ?>
        ...
        <article class="widget_custom_post_widget" <?php post_class($current_post); ?>>
          ...
          <?php if ($instance['show_excerpt']) : ?>
            <div class="entry-summary widget_content">
              <p>
                <?php echo the_advanced_excerpt('length=' . $instance[excerpt_length] . '&length_type=words'); ?>
                </p>
                </div>
              <p>
                ...
                <?php if ($instance['show_readmore']) : ?>
                      <li>
                  <a href="<?php the_permalink(); ?>" class=" button more-link"><?php echo $instance['excerpt_readmore']; ?></a>
                          </li>
                      </div>
                <?php endif; ?>
              </p>
