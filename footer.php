        ...
        <div class="medium-6 columns">
            ...
            <div class="footer__info">
                ...
                <?php if (get_option('facebook')) { ?>
                    <a class="facebook button" target="_blank" href="<?php echo get_option('facebook'); ?>" title="Join us on Facebook">
                        <i class="fi-social-facebook"><span class="visuallyhidden">Facebook</span></i>
                    </a><?php } ?>
                <?php if (get_option('twitter')) { ?>
                    <a class="twitter button" href="<?php echo 'http://twitter.com/' . get_option('twitter'); ?>" data-site-twitter="<?php echo get_option('twitter'); ?>" title="Join us on Twitter" target="_blank">
                            <i class="fi-social-twitter"><span class="visuallyhidden">Twitter</span></i>
                    </a><?php } ?>
                <?php if (get_option('youtube')) { ?>
                    <a class="youtube button" target="_blank" href="<?php echo get_option('youtube'); ?>" title="Join us on YouTube">
                            <i class="fi-social-youtube"><span class="visuallyhidden">YouTube</span></i>
                    </a><?php } ?>
                </div>
            </div>
        </div>
