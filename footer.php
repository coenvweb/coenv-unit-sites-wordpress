    ...
    <div class="row">
        <div class="medium-6 columns">
			...
			<div class="site-footer__header">
				<h2 class="show-for-small-only" id="logo"><a href="https://environment.uw.edu/" rel="home" title="UW College of the Environment"><img alt="College of the Environment Logo" src="<?php bloginfo('template_directory'); ?>/assets/img/uw-footer.svg" width="350" ></a></h2>
			</div>
            <div class="site-footer__header">
            ...
            <div class="footer__info">
                ...
                <?php if (get_option('facebook')) { ?>
                    <a class="facebook button" href="<?php echo get_option('facebook'); ?>" title="Join us on Facebook" target="_blank">
                        <i class="fi-social-facebook"></i><span class="visuallyhidden">Facebook</span>
                    </a><?php } ?>
                <?php if (get_option('twitter')) { ?>
                    <a class="twitter button" href="<?php echo 'http://twitter.com/' . get_option('twitter'); ?>" data-site-twitter="<?php echo get_option('twitter'); ?>" title="Join us on Twitter" target="_blank">
                            <i class="fi-social-twitter"></i><span class="visuallyhidden">Twitter</span>
                    </a><?php } ?>
                <?php if (get_option('youtube')) { ?>
                    <a class="youtube button" href="<?php echo get_option('youtube'); ?>" title="Join us on YouTube">
                            <i class="fi-social-youtube"></i><span class="visuallyhidden">YouTube</span>
                    </a><?php } ?>
                </div>
            </div>
        </div>
            ...
            <nav class="footer-nav">
                <div class="site-footer__header">
                    ...
                    <ul class="menu-footer-units">
                        ...
                        <li><a target="_blank" href="https://qrc.uw.edu/">Quaternary Research Center</a></li>
