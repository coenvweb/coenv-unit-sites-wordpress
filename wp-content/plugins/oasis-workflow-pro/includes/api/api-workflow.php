...
add_action('rest_api_init', function () {
   ...
   register_rest_route('oasis-workflow/v1', '/workflows/documentRevision/checkRevisionCapability/postId=(?P<post_id>\d+)', array(
      'methods' => 'GET',
      'callback' => array( $ow_revision_service, 'api_is_make_revision_allowed' )
   ) );
   
   // Register route to check for existing revision
   register_rest_route('oasis-workflow/v1', '/workflows/documentRevision/checkExistingRevision/postId=(?P<post_id>\d+)', array(
      'methods' => 'GET',
   ...
   register_rest_route('oasis-workflow/v1', '/workflows/documentRevision/checkCompareCapability/postId=(?P<post_id>\d+)', array(
      'methods' => 'GET',
   ...
   register_rest_route('oasis-workflow/v1', '/workflows/reassign/assignees/actionHistoryId=(?P<action_history_id>\d+)/taskUser=(?P<task_user>\d+|null)', array(
      'methods' => 'GET',
