...
export class Signoff extends Component {
   ...
   */
   ...
   render() {
      ...
      const { validationErrors, isLastStep, lastStepDecision, hideSignOff, signoffButtonText, assignActorLabel, dueDateLabel, displayDueDate, articleChecklist, redirectingLoader, 
