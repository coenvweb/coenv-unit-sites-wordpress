    ...
    value: function invokeSignoffAPI(form_data) {
      ...
      wp.apiFetch({
        ...
        if (submitResponse.success_response == false) {
          ...
          _this7.signoffPanelRef.current.scrollIntoView();
        } else {
          if (submitResponse.new_action_history_id != _this7.state.actionHistoryId) {
            _this7.setState({
              hideSignOff: true,
          ...
          if (submitResponse.redirect_link !== "") {
            ...
            _this7.props.handleResponse(submitResponse);
          }
        }
...
/* harmony import */ var _components_ow_editorial_comments__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/ow-editorial-comments */ "./src/components/ow-editorial-comments.js");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./util */ "./src/util.js");
/* harmony import */ var _components_custom_post_type_support__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/custom-post-type-support */ "./src/components/custom-post-type-support.js");
...
var OasisWorkflowProComponent = /*#__PURE__*/function (_Component) {
  ...
  function OasisWorkflowProComponent() {
    ...
    _this.state = {
      ...
      signOffResponse: "",
      hideSignoff: false,
      actionHistoryId: (0,_util__WEBPACK_IMPORTED_MODULE_15__.getActionHistoryIdFromURL)(),
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(OasisWorkflowProComponent, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.postMeta == undefined) {
        var hidePluginMessage = /*#__PURE__*/React.createElement(_components_custom_post_type_support__WEBPACK_IMPORTED_MODULE_16__["default"], null);
        this.setState({
          hidePlugin: true,
    ...
    value: function render() {
      ...
      }), isEditorialCommentActive ? /*#__PURE__*/React.createElement(_components_ow_editorial_comments__WEBPACK_IMPORTED_MODULE_14__["default"], null) : "")));
    }
  }]);
...
registerPlugin("oasis-workflow-pro-plugin", {
  icon: _util__WEBPACK_IMPORTED_MODULE_15__.pluginIcon,
  render: HOC
});
