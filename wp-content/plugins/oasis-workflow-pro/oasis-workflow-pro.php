...
define( 'OASISWF_VERSION', '4.7' );
define( 'OASISWF_DB_VERSION', '4.7' );
...
//		add_action( 'admin_init', array( $this, 'validate_free_version_exists' ) );
   ...
   public function load_css_and_js_files() {
	...
	public function custom_cron_interval( $interval ) {
		...
		$interval['minutes_15'] = array( 'interval' => 15 * 60, 'display' => '15 minutes' );
		$interval['minutes_30'] = array( 'interval' => 30 * 60, 'display' => '30 minutes' );
		$interval['minutes_45'] = array( 'interval' => 45 * 60, 'display' => '45 minutes' );
		$interval['hours_4'] = array( 'interval' => 240 * 60, 'display' => '4 Hours' );
		$interval['hours_8'] = array( 'interval' => 480 * 60, 'display' => '8 Hours' );
		return $interval;
	}
   ...
   /**
	...
	public function run_on_upgrade() {
		...
		if ( $plugin_options['version'] == "1.0.8" ) {
			$this->upgrade_database_1010();
		...
		} elseif ( $plugin_options['version'] == "1.0.9" ) {
			$this->upgrade_database_1010();
			$this->upgrade_database_202();
			$this->upgrade_database_21();
			$this->upgrade_database_22();
         ...
         $this->upgrade_database_45();
         $this->upgrade_database_46();
		} elseif ( $plugin_options['version'] == "1.0.10" ) {
			$this->upgrade_database_202();
			$this->upgrade_database_21();
			$this->upgrade_database_22();
			$this->upgrade_database_23();
         ...
         $this->upgrade_database_45();
         $this->upgrade_database_46();
		} elseif ( $plugin_options['version'] == "1.0.11" ) {
			$this->upgrade_database_202();
			$this->upgrade_database_21();
			$this->upgrade_database_22();
			$this->upgrade_database_23();
         ...
         $this->upgrade_database_45();
         $this->upgrade_database_46();
		} elseif ( $plugin_options['version'] == "2.0.0" ) {
			$this->upgrade_database_202();
			$this->upgrade_database_21();
			$this->upgrade_database_22();
			$this->upgrade_database_23();
