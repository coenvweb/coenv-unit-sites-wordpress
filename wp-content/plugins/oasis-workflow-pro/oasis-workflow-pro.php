...
define('OASISWF_VERSION', '7.2');
define('OASISWF_DB_VERSION', '7.2');
...
class OW_Plugin_Init
{
   ...
   public function register_custom_post_types()
   {
      ...
      register_post_status('owf_scheduledrev', array(
         ...
         'label_count' => _n_noop('Scheduled Revision <span class="count">(%s)</span>', 'Scheduled Revision <span class="count">(%s)</span>')
      ));
   ...
   public function get_email_assignees( $email_options ) {      
      ...
      $email_options["email_cc"] = array( "roles" => array(), "users" => array(), "external_users" => array() );
      $email_options["email_bcc"] = array( "roles" => array(), "users" => array(), "external_users" => array() );
   ...
   public function load_js_files_footer()
   {
      ...
      if (is_admin() && preg_match_all('/page=ow-settings&tab=external_user_settings(.*)/', $_SERVER['REQUEST_URI'], $matches)) {
         wp_enqueue_script('owf-external-users-settings', OASISWF_URL . 'js/pages/subpages/external-user.js', array('jquery'), OASISWF_VERSION);
      }
