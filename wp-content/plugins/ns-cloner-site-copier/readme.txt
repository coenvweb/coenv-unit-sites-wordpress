...
For even more powerful functionality, [check out NS Cloner Pro](https://wpsitecloner.com/pricing/?utm_campaign=in+plugin+referral&utm_source=ns-cloner&utm_medium=plugin&utm_content=pro+pricing)
...
= 4.4.9.2 - 2026.05.04 =
* Fix: Handle hooks when a site is being created to avoid errors with site activated plugins
* Code improvements
