...
abstract class Run_Library {
	 ...
	 * @return bool
	 */
	public static function purge_table( array $table ): bool {
	...
	public static function remove_crons(): void {
		...
		$cron_prefixes[] = FIXALTTEXT_GLOBAL;
		$cron_prefixes[] = FIXALTTEXT_OPTION;
		$cron_prefixes[] = FIXALTTEXT_SLUG;

		// Remove any WP prefixed crons
		$cron_prefixes[] = 'wp_' . FIXALTTEXT_GLOBAL;
		$cron_prefixes[] = 'wp_' . FIXALTTEXT_OPTION;
		$cron_prefixes[] = 'wp_' . FIXALTTEXT_SLUG;
	...
	public final static function prevent_caching( bool $wp_cache = false ): void {
		...
		if ( ! defined( 'FIXALTTEXT_HELPERSLIBRARY_DONOTCACHE' ) ) {

			// Flag to prevent this from running twice
			define( 'FIXALTTEXT_HELPERSLIBRARY_DONOTCACHE', true );
		...
		if ( $wp_cache && ! defined( 'FIXALTTEXT_HELPERSLIBRARY_DONOTCACHE_WP' ) ) {

			// Flag to prevent this from running twice
			define( 'FIXALTTEXT_HELPERSLIBRARY_DONOTCACHE_WP', true );
