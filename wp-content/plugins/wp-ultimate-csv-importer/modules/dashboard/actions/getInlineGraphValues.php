...
?>
<script src="<?php echo WP_CONTENT_URL; ?>/plugins/<?php echo WP_CONST_ULTIMATE_CSV_IMP_SLUG; ?>/js/jquery.js"
		type="text/javascript"></script>
<script src="<?php echo WP_CONTENT_URL; ?>/plugins/<?php echo WP_CONST_ULTIMATE_CSV_IMP_SLUG; ?>/js/jquery.sparkline.js"
		type="text/javascript"></script>
<script src="<?php echo WP_CONTENT_URL; ?>/plugins/<?php echo WP_CONST_ULTIMATE_CSV_IMP_SLUG; ?>/js/jquery.flot.min.js"
		type="text/javascript"></script>
<script>
