...
<!--[if gt IE 8]><!--> <html class="no-js" <?php language_attributes(); ?>> <!--<![endif]-->
    <head>
        ...
        <!--[if lt IE 8]>
            <link rel='stylesheet' id='screen-css'  href='<?php bloginfo('template_url'); ?>/styles/build/lt-ie8.css' type='text/css' media='all' />
        <![endif]-->
        <!--[if gte IE 8]><!--> 
            <link rel='stylesheet' id='screen-css'  href='<?php bloginfo('stylesheet_url'); ?>' type='text/css' media='all' />
        <!--<![endif]-->
                        ...
                        <header id="header" role="banner" class="site-header">
                            ...
                            <h1 id="logo">
                                <a href="<?php bloginfo('url') ?>" rel="home" title="<?php bloginfo('name') ?>">
                                    ...
                                    <!--[if lt IE 9]>
                                        <img src="wp-content/themes/future-of-ice-child/assets/img/logo_ice.png" />
                                    <![endif]-->
                                    <!--[if gt IE 8]><!-->
                                        <img src="wp-content/themes/future-of-ice-child/assets/img/logo_ice.svg" />
                                    <!--<![endif]-->
                                </a>
                            </h1>
